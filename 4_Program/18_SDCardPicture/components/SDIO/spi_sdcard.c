...
esp_err_t sd_spi_init(void)
{
    ...
    /* SD卡参数配置 */
    sdmmc_host_t host = {
        .flags = SDMMC_HOST_FLAG_SPI | SDMMC_HOST_FLAG_DEINIT_ARG,  /* 定义主机属性的标志：SPI协议且可调用deinit函数 */
        .slot = SPI2_HOST,                                          /* 使用SPI2端口 */
        .max_freq_khz = SDMMC_FREQ_DEFAULT,                         /* 主机支持的最大频率：20000 */
        .io_voltage = 3.3f,                                         /* 控制器使用的I/O电压 */
        .init = &sdspi_host_init,                                   /* 用于初始化驱动程序的主机函数 */
        .set_bus_width = NULL,                                      /* 设置总线宽度的主机功能 */
        .get_bus_width = NULL,                                      /* 取总线宽度的主机函数 */
        .set_bus_ddr_mode = NULL,                                   /* 设置DDR模式的主机功能 */
        ...
        .io_int_enable = &sdspi_host_io_int_enable,                 /* 启用SDIO中断线的主机功能 */
        .io_int_wait = &sdspi_host_io_int_wait,                     /* 等待SDIO中断线路激活的主机功能 */
        .command_timeout_ms = 0,                                    /* 超时，默认为0*/
